...
log_level = 'INFO'
work_dir = 'work_dirs/iou_2stage/vov_0075/0827_resolve_change_lr_mean'
...
custom_hooks = [
    dict(
        type="FreezeWeight",
        finetune_weight=["pts_bbox_head.task_heads.0.iou.0.weight", "pts_bbox_head.task_heads.0.iou.1.weight","pts_bbox_head.task_heads.0.iou.1.bias", "pts_bbox_head.task_heads.0.iou.3.weight", "pts_bbox_head.task_heads.0.iou.3.bias"]
    )
]
